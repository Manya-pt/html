                ...
                <tr>
                    <th colspan="10">
                        <form name="sform">
                            ...
                            <input class="sub2" type="button" value="Search" name="search" style="background-color: deepskyblue;" onclick="window.location.replace('p9.php?search='+document.sform.key.value)">
                        </form>
                    </th>
                </tr>
                <?php
